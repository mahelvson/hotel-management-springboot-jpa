...
public class UserResource {
	...
	@Operation(
			...
			description = "Attempts to regisster a new user, passing a UserType enum",
			tags = {"user", "client", "manager", "receptionist", "crud"},
			responses = {
	...
	@Operation(
			...
			description = "Attempt to update the register of a user.",
			tags = {"users, crud"},
			responses = {
	...
	@Tag(name="User")
	@Operation(
			summary = "Remove a single user by its ID",
	...
	@Tag(name="Client")
	@Operation(
			summary = "Search client by E-mail (username)",
			description = "Return a single client passing its E-mail",
			tags = {"clients"},
			responses = {
					@ApiResponse(responseCode = "200", description = "Client info listed"),
					@ApiResponse(responseCode = "404", description = "Client not found"),
	...
	@Tag(name="Receptionist")
	@Operation(
			summary = "Search a receptionists by ID",
	...
	@Operation(
			...
			description = "Return a single receptionist passing its E-mail",
			tags = {"receptionists"},
			responses = {
					@ApiResponse(responseCode = "200", description = "Receptionist info listed"),
					@ApiResponse(responseCode = "404", description = "Receptionist not found"),
	...
	@Tag(name="Managers")
	@Operation(
			summary = "Search for all managers",
